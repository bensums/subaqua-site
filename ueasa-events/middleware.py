...
class IgnoreFbCsrfMiddleware(object):
    ...
    def process_request(self, request):
        ...
        if signed_request == None:
            return
        signed_request = fb_decode_signed_request(signed_request,
...
def fb_decode_signed_request(signed_request, app_secret):
    """
    Decode Facebook's signed_request. Fail if signature cannot be verified
    since this indicates the request likely does not originate from Facebook.
    """
